...
bool file_backed_initializer(struct page *page, enum vm_type type, void *kva) {
    ...
    struct aux_container *lazy_load_arg = (struct aux_container *)page->uninit.aux;
    file_page->file = lazy_load_arg->file;
    file_page->ofs = lazy_load_arg->offset;
...
do_mmap(void *addr, size_t length, int writable,
    ...
    while (read_bytes > 0 || zero_bytes > 0) {
        ...
        struct aux_container *lazy_load_arg = (struct aux_container *)malloc(sizeof(struct aux_container));
        ...
        p->map_page_count = total_page_count;
